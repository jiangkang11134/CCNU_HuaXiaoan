  ...
  >
    ...
    <template #options-left>
      <AttachmentOptionsComponent
        v-if="hasAttachmentOptions"
        :disabled="disabled"
        :file-upload-visible="supportsFileUpload"
        :image-upload-visible="supportsImageUpload"
...
const hasAttachmentOptions = computed(() => props.supportsFileUpload || props.supportsImageUpload)
...
const handleAttachmentUpload = (files = []) => {
  if (!props.supportsFileUpload) return
...
const handlePastedImage = async (file) => {
  if (props.disabled || !props.supportsImageUpload) return
