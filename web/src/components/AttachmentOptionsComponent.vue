<template>
  <div class="attachment-options">
    <div v-if="fileUploadVisible" class="option-item" :class="{ disabled: disabled }" @click="handleAttachmentClick">
    ...
    <div v-if="imageUploadVisible" class="option-item" @click="handleImageUpload">
