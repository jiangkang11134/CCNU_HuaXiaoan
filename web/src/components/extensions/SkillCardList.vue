            ...
            <a-tab-pane key="repo" tab="按仓库拉取">
              <div class="tab-content-wrapper">
                <a-form layout="vertical" class="remote-install-form">
                  ...
                  <div class="repo-hint-text">请输入管理员确认过的 Skill 来源地址。</div>
            ...
            <a-tab-pane key="search" tab="全局搜索发现">
              <div class="tab-content-wrapper">
                <a-form layout="vertical" class="remote-install-form">
                  ...
                  <div class="repo-hint-text">输入关键字检索可安装的 Skills。</div>
...
const navigateToDetail = (skill) => {
  router.push({ path: `/back/extensions/skill/${encodeURIComponent(skill.slug)}` })
}
