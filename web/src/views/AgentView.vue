...
const { agents, selectedAgentId, isLoadingConfig, frontendChatConfig } = storeToRefs(agentStore)
const frontendConfig = computed(() => (userStore.isChatOnlyUser ? frontendChatConfig.value : null))
