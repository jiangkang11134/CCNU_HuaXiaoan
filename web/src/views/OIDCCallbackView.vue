...
import { getLandingPathForRole, getPortalLoginPath } from '@/utils/portal'
...
// 返回登录页
const goToLogin = () => {
  router.push(getPortalLoginPath())
}
...
const handleCallback = async () => {
  try {
    ...
    userStore.businessRole = tokenData.business_role || ''
    userStore.isBuiltin = Boolean(tokenData.is_builtin)
